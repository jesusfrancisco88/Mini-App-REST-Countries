...
.then(data => {
  ...
  <p class='data-display'><span>Language: ${Object.values(data[0].languages).toString()}</span></p>
  </div>
  ...
  if (countryName.length == 0) {
    ...
    result.innerHTML = `<h3 class='error-msg'>Please enter a valid country name.</h3>`;
  }
});
});
